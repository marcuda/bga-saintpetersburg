...
$machinestates = array(
    ...
    STATE_SELECT_CARD => array(
    	"name" => "selectCard",
    	"description" => clienttranslate('${card}: ${actplayer} must choose an action or cancel'),
    	"descriptionmyturn" => clienttranslate('${card}: ${you} may buy or add to hand'),
    	"type" => "activeplayer",
	"args" => "argSelectCard",
    	"possibleactions" => array("buyCard", "addCard", "cancel"),
    	"transitions" => array(
